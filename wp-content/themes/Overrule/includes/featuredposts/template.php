        ...
        <?php if($the_slider) {
            ...
            foreach ($the_slider as $slider) { ?>
                ...
                <div class="fp-slides-items">
                    ...
                    <?php if( $this->theme->display('post_title', $featuredposts_moreoptions) || $this->theme->display('post_excerpt', $featuredposts_moreoptions) || $this->theme->display('next_prev', $featuredposts_moreoptions)) { ?>
