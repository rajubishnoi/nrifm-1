    ...
    class Themater_FeaturedPosts
    {
        ...
        var $defaults = array(
            ...
            'custom_default_slides' => array(
                '1' => array('link' => '#', 'title' => 'This is default featured slide 1 title', 'content' => 'You can completely customize the featured slides from the theme theme options page. You can also easily hide the featured posts slideshow from certain parts of your site like: categories, tags, archives etc.'), 
                '2' => array('link' => '#', 'title' => 'This is default featured slide 2 title', 'content' => 'You can completely customize the featured slides from the theme theme options page. You can also easily hide the featured posts slideshow from certain parts of your site like: categories, tags, archives etc.'), 
                '3' => array('link' => '#', 'title' => 'This is default featured slide 3 title', 'content' => 'You can completely customize the featured slides from the theme theme options page. You can also easily hide the featured posts slideshow from certain parts of your site like: categories, tags, archives etc.'), 
                '4' => array('link' => '#', 'title' => 'This is default featured slide 4 title', 'content' => 'You can completely customize the featured slides from the theme theme options page. You can also easily hide the featured posts slideshow from certain parts of your site like: categories, tags, archives etc.'), 
                '5' => array('link' => '#', 'title' => 'This is default featured slide 5 title', 'content' => 'You can completely customize the featured slides from the theme theme options page. You can also easily hide the featured posts slideshow from certain parts of your site like: categories, tags, archives etc.')
            )
        );
        ...
        function themater_options()
        {
            ...
            $this->theme->admin_option('Featured Posts', 
                ...
                'content','<i>TThe images for the "Category Posts", "Selected Posts" and "Selected Pages" should be added using the "Set Featured Image" link, located under categories list at post write/edit page. ' . $image_sizes . '</i>'
            );
