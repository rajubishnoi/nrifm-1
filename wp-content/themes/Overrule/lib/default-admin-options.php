...
*/
    ...
    */
        ...
        $this->admin_option('General', 
            ...
            array('display' => 'minimal', 'help' => "Enter the full url to your logo image. Leave it blank if you don't want to use a logo image.")
        );
    ...
    */
    ...
    $this->theme_name = $get_theme_data['Author'];
