...
<div id="sidebar">
		...
		<?php if ( ! dynamic_sidebar( 'sidebar-1' ) ) : ?>			
			...
			<div class="widget widget_text">
				<h3><?php _e( 'Max Responsive Wordpress Theme', 'curiosity' ); ?></h3>			
				<div class="textwidget"><?php _e( 'Thank you for using this free theme. If you have questions, please feel free contact.', 'curiosity' ); ?></div>
			</div>
			...
			<div class="widget">
				<h3><?php _e( 'Popular Categories', 'curiosity' ); ?></h3>
				<ul><?php wp_list_categories( array( 'orderby' => 'count', 'order' => 'DESC', 'title_li' => '', 'number' => 10 ) ); ?></ul>
			</div>
					
			<div class="widget widget_archive">
				<h3 class="widget-title"><?php _e( 'Archives', 'curiosity' ); ?></h3>
				<ul>
