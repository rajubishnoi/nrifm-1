...
<?php get_header(); ?>
	...
	<div id="content">
		<div id="post-0" class="post">
			<h2><?php _e( 'This is somewhat embarrassing, isn&rsquo;t it?', 'curiosity' ); ?></h2>
				
				
				<div class="post-entry">
					<p><?php _e('You are trying to reach a page that does not exist here. Either it has been moved or you typed a wrong address.', 'curiosity'); ?></p>
					...
					<div class="widget">
						<h3><?php _e( 'Most Used Categories', 'curiosity' ); ?></h3>
