...
function max_magazine_twitter_widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'widget_tweets', 'description' => __('A widget to display latest tweets in the theme.', 'curiosity') );

		/* Create the widget */
		$this->WP_Widget( 'max_magazine_twitter_widget', __('Max: Latest Tweets', 'curiosity'), $widget_ops );
	}
...
function update( $new_instance, $old_instance ) {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e('Twitter username:', 'curiosity') ?></label>
